...
class PizzaBulder extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      stateOfPizza: ["https://i.ibb.co/cLdL2JV/Drawing.png"]
    }
  }
  ...
  setStateOfPizza = (image) => {
    this.setState((prev) => ({ ...prev, stateOfPizza: [...prev.stateOfPizza, image] }))
    console.log(this.state.stateOfPizza);
    ...
    return (
      <div className="main_block">
        <div className="section section_options">
          ...
          <Ingredients selectedCatIngs={this.state.selectedCatIngs} setStateOfPizza={this.setStateOfPizza} />
        </div>
        <div className="section section_pizza">
          ...
          <div className="main_pizza_block">
            <Pizza stateOfPizza={this.state.stateOfPizza}/>
